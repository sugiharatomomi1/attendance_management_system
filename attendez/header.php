...
<nav> 
   <ul class="main-nav"> 
    ...
    <li><a href="attend_state.php">出欠情報</a></li>
    ...
    <li><a href="students_modify_select.php">学生管理</a></li>
        <li><a href="student_regist.php">学生新規登録</a></li> 
        <li><a href="students_modify_select.php">学生登録情報変更</a></li> 

    <li><a href="question_modify_select.php">問題</a></li> 
    ...
    <li><a href="admin_modify.php">管理者</a></li> 
